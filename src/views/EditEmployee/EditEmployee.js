  ...
  useEffect(() => {
    ...
    axios.get(window.location.pathname).then((result) => {
      ...
      setFormState({
        ...formState,
        values: {
          firstName: employee.v_name.split(" ")[0],
          lastName: employee.v_name.split(" ")[1],
          email: employee.v_email,
          gender: employee.e_gender,
          department: employee.v_department,
          // imgURL:employee.v_imgURL
        },
      });
    });
  }, []);
  ...
  const handleSubmit = (event) => {
    ...
    axios({
      ...
      data: {
        ...
        e_gender: formState.values.gender,
      },
    })
      .then((result) => {
            ...
            <Card className={classes.formCard}>
              ...
              <form className={classes.form} onSubmit={handleSubmit}>
                ...
                <Typography
                  ...
                  variant="body1"
                >
                  To go back to employee list,{" "}
                  <Link component={RouterLink} to="/employees" variant="h6">
                    Click here
                  </Link>
                </Typography>
              </form>
